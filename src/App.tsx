...
import { ChevronDown, Terminal, Code, Smartphone, Mic, GitBranch, Users, Zap } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-900 rounded-lg p-8 border border-gray-700">
            <p className="text-lg md:text-xl leading-relaxed mb-6">
              ...
              <span className="text-purple-400 font-mono"> AI-augmented</span> developer toolset 
              that starts where you already live—the terminal.
            </p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6 text-lg md:text-xl leading-relaxed">
            <p>
              ...
              <span className="text-green-400 font-mono"> DevTools</span> is red-hot, 
              but ripe for disruption.
            </p>
            <p className="text-gray-300">
              While others build yet another IDE or web-based tool, 
              we start where developers already live—
            </p>
      ...
      <section id="join" className="py-20 px-4 border-t border-gray-800">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Community-first, open source roots. Be among the first to shape the future of development tools.
          </p>
